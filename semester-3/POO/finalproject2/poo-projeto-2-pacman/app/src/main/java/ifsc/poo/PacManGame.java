...
public class PacManGame extends JPanel implements ActionListener, KeyListener {
    ...
    PacManGame() {
        ...
        //load images
        this.wallImage = this.imgFromFile("./wall.png");
        this.blueGhostImage = this.imgFromFile("./blueGhost.png");
        this.orangeGhostImage = this.imgFromFile("./orangeGhost.png");
        this.pinkGhostImage = this.imgFromFile("./pinkGhost.png");
        this.redGhostImage = this.imgFromFile("./redGhost.png");

        this.pacmanUpImage = this.imgFromFile("./pacmanUp.png");
        this.pacmanDownImage = this.imgFromFile("./pacmanDown.png");
        ...
        for (int r = 0; r < rowCount; r++) {
            for (int c = 0; c < columnCount; c++) {
                ...
                if (tileMapChar == 'X') { //block wall
                    ...
                    Block ghost = new Block(this.blueGhostImage, x, y, tileSize, tileSize);
                    ghosts.add(ghost);
                }
                else if (tileMapChar == 'o') { //orange ghost
                    Block ghost = new Block(this.orangeGhostImage, x, y, tileSize, tileSize);
                    ghosts.add(ghost);
                }
                else if (tileMapChar == 'p') { //pink ghost
                    Block ghost = new Block(this.pinkGhostImage, x, y, tileSize, tileSize);
                    ghosts.add(ghost);
                }
                else if (tileMapChar == 'r') { //red ghost
                    Block ghost = new Block(this.redGhostImage, x, y, tileSize, tileSize);
                    ghosts.add(ghost);
                }
    ...
    public void move() {
        ...
        for (Block food : foods) {
            if (detectCollision(pacman, food)) {
                foodEaten = food;
                score += 10;
            }
        }
